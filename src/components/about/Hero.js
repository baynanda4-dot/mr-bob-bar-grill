  ...
  return (
    <section className="relative h-[50vh] bg-mrbob-black flex flex-col items-center justify-center text-center text-white px-6">
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <h1 className="text-5xl font-light tracking-normal mb-4">Built Around the Fire</h1>
        <p className="max-w-xl mx-auto text-sm text-gray-200">
          The story behind Mr Bob Bar and Grill: steaks, ribs, tomahawk, wine, and live music.
        </p>
      </div>
    </section>
  );
